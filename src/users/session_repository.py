...
async def insert_user_credential(user_credential: UserCredentials) -> InsertOneResult:
    db = connectMongoDB()
    inserted_data = await db.insert_document(CREDENTIALS_COLLECTION, user_credential)
